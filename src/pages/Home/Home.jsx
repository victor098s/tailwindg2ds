...
const services = [
  {
    title: "Banho e Tosa",
    description:
      "Tratamento completo com carinho e produtos premium para pelagem brilhante.",
    icon: PawPrint,
  },
  {
  ...
  },
  {
    ...
    description:
      "Cuidamos da imunização e conforto dos seus animais de companhia.",
    icon: ShieldCheck,
  },
  {
    title: "Delivery Pet",
    description:
      "Produtos e ração entregues em casa com agilidade e segurança.",
    icon: Sparkles,
  },
];
...
const featured = [
  {
    title: "Pote de comida para cachorro",
    description: "Alimentação balanceada para manter seu pet saudável e feliz.",
  },
  {
    title: "Brinquedo para cachorro",
    description: "Diversão segura e interativa para estimular o corpo e a mente.",
  },
  {
    title: "Osso de roer para cachorro",
    description: "Entretenimento saudável que ajuda na higiene bucal e fortalece os dentes.",
  },
  {
    title: "Pedigree para cachorro",
    description: "Alimentação de qualidade para manter seu pet saudável e feliz.",
  },
];
    ...
    <div className="space-y-20">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-2xl text-slate-300">
              PetLume é a pet shop que combina amor, saúde e modernidade com
              planos de mensalidade pensados para cuidar do seu pet todos os
              meses.
            </p>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <Link
                to="/planos"
                className="inline-flex w-full items-center justify-center rounded-full bg-orange-500 px-6 py-3 text-sm font-semibold text-slate-950 transition hover:bg-orange-400 sm:w-auto"
              >
                Ver planos de mensalidade
              </Link>
              <Link
                to="/contato"
                className="inline-flex w-full items-center justify-center rounded-full border border-slate-700 bg-transparent px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-orange-400 sm:w-auto"
              >
                Fale com a equipe
              </Link>
            </div>
            ...
            <div className="space-y-4">
              <div className="rounded-3xl bg-[#0f172a] p-6 text-center text-slate-100 shadow-inner shadow-slate-900/30">
                ...
                <p className="mt-2 text-slate-400">
                  Planos mensais com banho, tosa e acompanhamento nutricional.
                </p>
              </div>
              <div className="grid gap-4 sm:grid-cols-2">
                {featured.map((item) => (
                  <div
                    key={item.title}
                    className="rounded-3xl border border-white/5 bg-slate-950/80 p-5 text-left"
                  >
      ...
      <section className="space-y-8">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="text-3xl font-bold text-white">
              Serviços que seu pet vai adorar
            </h2>
          </div>
          <p className="max-w-xl text-slate-400">
            Uma experiência preparada para saúde, bem-estar e proteção em um só
            lugar.
          </p>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service) => (
            <div
              key={service.title}
              className="rounded-3xl border border-white/10 bg-slate-950/80 p-6 text-center shadow-xl shadow-black/20"
            >
      ...
      <section className="space-y-8">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          ...
          <Link
            to="/produtos"
            className="inline-flex items-center rounded-full border border-orange-500/50 bg-orange-500/10 px-5 py-3 text-sm font-semibold text-orange-100 transition hover:bg-orange-500/20"
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-3 text-slate-300">
                  Preço:{" "}
                  <span className="font-bold text-green-500">R$ 50,00</span>
                </p>
              </div>
              <button
                type="button"
          ...
          <article className="rounded-[2rem] border border-white/10 bg-slate-950/85 p-6 shadow-xl shadow-black/20 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-slate-900/95">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-3 text-slate-300">
                  Preço:{" "}
                  <span className="font-bold text-green-500">R$ 20,00</span>
                </p>
              </div>
              <button
                type="button"
          ...
          <article className="rounded-[2rem] border border-white/10 bg-slate-950/85 p-6 shadow-xl shadow-black/20 transition hover:-translate-y-1 hover:border-orange-400/40 hover:bg-slate-900/95">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-3 text-slate-300">
                  Preço:{" "}
                  <span className="font-bold text-green-500">R$ 90,00</span>
                </p>
              </div>
              <button
                type="button"
      ...
      <section className="rounded-[2rem] border border-orange-500/20 bg-gradient-to-r from-[#031025] via-[#08172e] to-[#10203b] p-10 shadow-2xl shadow-orange-500/10">
        <div className="grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-center">
          <div className="space-y-5">
            ...
            <h2 className="text-3xl font-bold text-white">
              Deixe seu pet sempre protegido com nossos planos mensais.
            </h2>
            <p className="max-w-xl text-slate-300">
              Simplifique o cuidado com o seu pet: planos mensais acessíveis,
              atendimento dedicado e benefícios exclusivos a cada mês.
            </p>
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                to="/contato"
                className="rounded-full border border-slate-700 px-6 py-3 text-sm font-semibold text-slate-100 transition hover:border-orange-400"
              >
                Entrar em contato
              </Link>
            </div>
          ...
          <div className="rounded-3xl border border-white/10 bg-slate-950/80 p-8">
            <div className="space-y-4">
              <div className="rounded-3xl bg-slate-900 p-6 text-slate-100">
                ...
                <p className="mt-2 text-slate-400">
                  Banho e tosa mensal + limpeza express.
                </p>
              </div>
