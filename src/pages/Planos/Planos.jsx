      ...
      <section className="rounded-[2rem] border border-orange-500/20 bg-slate-950/80 p-8 shadow-2xl shadow-orange-500/10">
        <div className="space-y-4">
          ...
          <p className="max-w-3xl text-slate-300">
            Planos flexíveis com benefícios exclusivos para garantir mais saúde,
            conforto e economia mês a mês. Para assinar o plano, vá à unidade
            mais próxima.{" "}
          </p>
        </div>
      </section>
            ...
            extra={
              <ul className="mt-6 space-y-3 text-slate-300">
                {plan.features.map((feature) => (
                  <li
                    key={feature}
                    className="flex items-center gap-3 text-sm before:inline-block before:h-2 before:w-2 before:rounded-full before:bg-orange-400"
                  >
                    {feature}
                  </li>
                ))}
